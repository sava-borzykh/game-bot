...
def cat_dog(photo):
    try:
        ...
        if not os.path.exists(model_path):
            url = "https://drive.google.com/uc?export=download&id=1JIyaGXFQDBDsutE20n9gpJMtdggaQRS4&confirm=t"
...
def start(message):
    try:
        ...
        button4 = telebot.types.KeyboardButton(text="Распознавание цифр")
        button5 = telebot.types.KeyboardButton(text="Распознавание животных")
